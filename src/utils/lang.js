const ch2en = {
  ...
  "选择您拥有的账户(此账户用于创建新账户)":"Choose the account you have (this account is used to create a new account)",
  ...
  "如无公钥，请前往“账户管理”->“密钥”页面创建公私钥":"If you do not have a public key, go to the Account Management -> Keys page to create a public and private key.",
  "其它公钥":"Other public key",
  "若此处填入公钥，创建时将以此公钥为准":"If the public key is filled in here, the public key will be subject to the creation.",
  "账号描述":"Account description",
  "附带转账金额(单位":"With transfer amount (unit",
  "创建新账号的同时，可向此账号转账，默认为0":"When creating a new account, you can transfer money to this account. The default is 0.",
  ...
  "钱包密码，由数字加字母组成，不少于8位":"Wallet password, consisting of numbers plus letters, no less than 8 digits",
  "通知":"Notice",
  ...
  "需改变创办者的资产":"the asset which founder will be changed",
  ...
  "待增发的资产":"asset to be increased",
  "选择需要增发的资产ID":"Please select asset",
  "增发金额":"value increased",
  "增发对象":"account to be increased",
  ...
  "需改变管理者的资产":"asset which manager will be changed",
